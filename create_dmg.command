...
set position of item "'${APP_NAME}'.app" of container window to {160, 70}
set position of item "Applications" of container window to {360, 70}
set position of item "README.txt" of container window to {160, 250}
set position of item "LICENSE.txt" of container window to {360, 250}
close
open
